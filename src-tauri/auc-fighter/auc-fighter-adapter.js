...
function ip() {
	...
	(W.prototype.isReactComponent = {}),
		(W.prototype.setState = function (h, E) {
	...
	function Fe(h, E, X) {
		...
		if (E != null)
			...
			E))
				ue.call(E, Z) && !te.hasOwnProperty(Z) && (ne[Z] = E[Z]);
	...
	function st(h, E, X, Z, ne) {
		...
		if (ae)
			return (
				...
				Y(ne)
					? ((X = ""),
						h != null && (X = h.replace(gt, "$&/") + "/"),
						st(ne, E, X, "", function (Ge) {
							return Ge;
						}))
					: ne != null &&
						(ot(ne) &&
		...
		else if (((pe = j(h)), typeof pe == "function"))
			for (h = pe.call(h), ie = 0; !(re = h.next()).done; )
				(re = re.value), (pe = Z + Xe(re, ie++)), (ae += st(re, E, X, pe, ne));
		else if (re === "object")
			throw (
				((E = String(h)),
				Error(
	...
	return (
		...
		(G.cloneElement = function (h, E, X) {
			...
			if (E != null) {
				if (
					(E.ref !== void 0 && ((re = E.ref), (ae = ee.current)),
				...
				for (pe in E)
					ue.call(E, pe) &&
						!te.hasOwnProperty(pe) &&
						(Z[pe] = E[pe] === void 0 && ie !== void 0 ? ie[pe] : E[pe]);
			}
...
function op() {
	...
	function _(N, S, F) {
		...
		F !== void 0 && (j = "" + F),
			...
			S.ref !== void 0 && (K = S.ref);
		for (M in S) f.call(S, M) && !w.hasOwnProperty(M) && (A[M] = S[M]);
		if (N && N.defaultProps)
			for (M in ((S = N.defaultProps), S)) A[M] === void 0 && (A[M] = S[M]);
		return {
			$$typeof: s,
			type: N,
			key: j,
			...
			(function (i) {
				...
				function Q(T) {
					for (var H = a(F); H !== null; ) {
						if (H.callback === null) f(F);
							...
							f(F), (H.sortIndex = H.expirationTime), s(S, H);
						else break;
						H = a(F);
					}
				}
				...
				function ue(T, H) {
					...
					try {
						for (
							Q(H), A = a(S);
							A !== null && (!(A.expirationTime > H) || (T && !nn()));
						) {
							var h = A.callback;
						...
						return (
							...
							O > h
								? ((T.sortIndex = O),
									...
									a(S) === null &&
										T === a(F) &&
										(J ? (se(Fe), (Fe = -1)) : (J = !0), ge(Y, O - h)))
								: ((T.sortIndex = E), s(S, T), b || K || ((b = !0), Ue(ue))),
							T
						);
					}),
...
` + l[o].replace(" at new ", " at ");
	...
	function iu(e, t) {
		...
		t.hasOwnProperty("value")
			? ou(e, t.type, n)
			: t.hasOwnProperty("defaultValue") && ou(e, t.type, ie(t.defaultValue)),
			t.checked == null &&
	...
	var Ho = s.unstable_scheduleCallback,
		Vo = s.unstable_cancelCallback,
		yf = s.unstable_shouldYield,
		vf = s.unstable_requestPaint,
		Se = s.unstable_now,
		gf = s.unstable_getCurrentPriorityLevel,
		gu = s.unstable_ImmediatePriority,
		$o = s.unstable_UserBlockingPriority,
		Br = s.unstable_NormalPriority,
		wf = s.unstable_LowPriority,
		Qo = s.unstable_IdlePriority,
		Wr = null,
		St = null;
	function Sf(e) {
	...
	var at = Math.clz32 ? Math.clz32 : Ef,
		kf = Math.log,
		_f = Math.LN2;
	function Ef(e) {
	...
	function Tf(e, t, n, r, l) {
		switch (t) {
			...
			case "gotpointercapture":
				return (
					(u = l.pointerId), tr.set(u, nr(tr.get(u) || null, e, t, n, r, l)), !0
				);
		}
		return !1;
	}
	...
	function lr(e) {
		...
		for (; 0 < Bt.length && ((n = Bt[0]), n.blockedOn === null); )
			bo(n), n.blockedOn === null && Bt.shift();
	}
	var En = Y.ReactCurrentBatchConfig,
		Xr = !0;
	function Mf(e, t, n, r) {
		var l = oe,
			u = En.transition;
	...
	var Gr = null;
	function xu(e, t, n, r) {
		if (((Gr = null), (e = pu(r)), (e = ln(e)), e !== null))
	...
	var Cn = {
		...
		qr = O({}, ur, {
			...
			movementX: function (e) {
				return "movementX" in e
					...
					: (e !== ir &&
							(ir && e.type === "mousemove"
								? ((Tu = e.screenX - ir.screenX), (Ru = e.screenY - ir.screenY))
								: (Ru = Tu = 0),
							(ir = e)),
						Tu);
			},
		...
		ls = Ye(qr),
		Lf = O({}, qr, { dataTransfer: 0 }),
		If = Ye(Lf),
		Df = O({}, ur, { relatedTarget: 0 }),
		Mu = Ye(Df),
		Ff = O({}, Cn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
		Af = Ye(Ff),
		jf = O({}, Cn, {
	...
	var Qf = O({}, ur, {
		...
		Yf = Ye(Gf),
		Zf = O({}, Cn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
		Jf = Ye(Zf),
		qf = O({}, qr, {
			deltaX: function (e) {
				return "deltaX" in e
		...
		bf = Ye(qf),
		ed = [9, 13, 27, 32],
		Ou = N && "CompositionEvent" in window,
		or = null;
	N && "documentMode" in document && (or = document.documentMode);
	var td = N && "TextEvent" in window && !or,
		os = N && (!Ou || (or && 8 < or && 11 >= or)),
		ss = " ",
		as = !1;
	function cs(e, t) {
		switch (e) {
	...
	function rd(e, t) {
		if (xn)
			return e === "compositionend" || (!Ou && cs(e, t))
				? ((e = ns()), (Yr = Pu = Wt = null), (xn = !1), e)
				: null;
		switch (e) {
			case "paste":
				return null;
	...
	function od(e, t, n) {
		e === "focusin"
			? (ys(), (sr = t), (ar = n), sr.attachEvent("onpropertychange", vs))
			: e === "focusout" && ys();
	}
	function sd(e) {
	...
	var pd = N && "documentMode" in document && 11 >= document.documentMode,
		Pn = null,
		Fu = null,
		fr = null,
		Au = !1;
	...
	var Cs = tl("animationend"),
		xs = tl("animationiteration"),
		Ps = tl("animationstart"),
		Ns = tl("transitionend"),
		Ts = /* @__PURE__ */ new Map(),
		Rs =
	...
	for (var Uu = 0; Uu < Rs.length; Uu++) {
		var Bu = Rs[Uu],
			hd = Bu.toLowerCase(),
			md = Bu[0].toUpperCase() + Bu.slice(1);
		Ht(hd, "on" + md);
	}
	Ht(Cs, "onAnimationEnd"),
		Ht(xs, "onAnimationIteration"),
		Ht(Ps, "onAnimationStart"),
		Ht("dblclick", "onDoubleClick"),
		Ht("focusin", "onFocus"),
		Ht("focusout", "onBlur"),
		Ht(Ns, "onTransitionEnd"),
		...
		Ao(function () {
			...
			e: {
				...
				if (k !== void 0) {
					...
					for (var p = g, v; p !== null; ) {
						...
						if (
							(v.tag === 5 &&
								...
								((v = P),
								y !== null &&
									((P = Yn(p, y)), P != null && I.push(hr(p, P, v)))),
							ke)
						)
							break;
						p = p.return;
					...
					0 < I.length &&
						((k = new R(k, L, null, n, C)), x.push({ event: k, listeners: I }));
				}
			}
			if ((t & 7) === 0) {
				e: {
					...
					if (
						...
						if (
							...
							(ke = R == null ? k : Mn(R)),
							(v = L == null ? k : Mn(L)),
							(k = new I(P, p + "leave", R, n, C)),
							(k.target = ke),
							(k.relatedTarget = v),
							(P = null),
							ln(C) === g &&
								((I = new I(y, p + "enter", L, n, C)),
								(I.target = v),
								(I.relatedTarget = ke),
								(P = I)),
							(ke = P),
						...
						R !== null && Ls(x, k, R, I, !1),
							L !== null && ke !== null && Ls(x, ke, L, I, !0);
					}
				}
				e: {
					if (
						((k = g ? Mn(g) : window),
						(R = k.nodeName && k.nodeName.toLowerCase()),
						R === "select" || (R === "input" && k.type === "file"))
					)
						var D = id;
					else if (ds(k))
						if (hs) D = cd;
				...
				$ &&
					...
					0 < U.length &&
						(($ = new us($, e, null, n, C)),
						x.push({ event: $, listeners: U }),
						B ? ($.data = B) : ((B = fs(n)), B !== null && ($.data = B)))),
					(B = td ? nd(e, n) : rd(e, n)) &&
						((g = rl(g, "onBeforeInput")),
						0 < g.length &&
							((C = new us("onBeforeInput", "beforeinput", null, n, C)),
							x.push({ event: C, listeners: g }),
							(C.data = B)));
			}
			zs(x, t);
		});
	...
	function rl(e, t) {
		for (var n = t + "Capture", r = []; e !== null; ) {
			...
			l.tag === 5 &&
				...
				((l = u),
				(u = Yn(e, n)),
				u != null && r.unshift(hr(e, u, l)),
				(u = Yn(e, t)),
				u != null && r.push(hr(e, u, l))),
				(e = e.return);
		}
		return r;
	}
	...
	function Ls(e, t, n, r, l) {
		for (var u = t._reactName, o = []; n !== null && n !== r; ) {
			...
			c.tag === 5 &&
				...
				((c = g),
				l
					? ((d = Yn(n, u)), d != null && o.unshift(hr(n, d, c)))
					: l || ((d = Yn(n, u)), d != null && o.push(hr(n, d, c)))),
				(n = n.return);
		}
...
`,
	...
	var Rn = Math.random().toString(36).slice(2),
		...
		Gu = "__reactEvents$" + Rn,
		_d = "__reactListeners$" + Rn,
		Ed = "__reactHandles$" + Rn;
	function ln(e) {
		var t = e[kt];
		if (t) return t;
	...
	function qu(e) {
		for (; e === cl; )
			(cl = Ln[--In]), (Ln[In] = null), (fl = Ln[--In]), (Ln[In] = null);
		for (; e === on; )
			(on = tt[--nt]),
				(tt[nt] = null),
				(Mt = tt[--nt]),
		...
		switch (e.tag) {
				...
				return (
					(t =
						t.nodeType !== 1 || n.toLowerCase() !== t.nodeName.toLowerCase()
							...
							: t),
					t !== null
						? ((e.stateNode = t), (Ze = e), (Je = Vt(t.firstChild)), !0)
						: !1
				);
			case 6:
				return (
			...
			case 13:
				return (
					...
					t !== null
						? ((n = on !== null ? { id: Rt, overflow: Mt } : null),
							(e.memoizedState = {
								dehydrated: t,
								treeContext: n,
	...
	function Xs(e) {
		...
		function c(y, p, v, P) {
			return p === null || p.tag !== 6
				? ((p = Ki(v, y.mode, P)), (p.return = y), p)
				: ((p = l(p, v)), (p.return = y), p);
		}
		function d(y, p, v, P) {
			var D = v.type;
			return D === te
				? C(y, p, v.props.children, P, v.key)
				: p !== null &&
						(p.elementType === D ||
							(typeof D == "object" &&
								D !== null &&
								D.$$typeof === Ue &&
								Ks(D) === p.type))
					? ((P = l(p, v.props)), (P.ref = vr(y, p, v)), (P.return = y), P)
					: ((P = Al(v.type, v.key, v.props, null, y.mode, P)),
						(P.ref = vr(y, p, v)),
						(P.return = y),
						P);
		}
		function g(y, p, v, P) {
			return p === null ||
				...
				? ((p = Xi(v, y.mode, P)), (p.return = y), p)
				: ((p = l(p, v.children || [])), (p.return = y), p);
		}
		function C(y, p, v, P, D) {
			return p === null || p.tag !== 7
				? ((p = yn(v, y.mode, P, D)), (p.return = y), p)
				: ((p = l(p, v)), (p.return = y), p);
		}
		function x(y, p, v) {
			if ((typeof p == "string" && p !== "") || typeof p == "number")
				return (p = Ki("" + p, y.mode, v)), (p.return = y), p;
			if (typeof p == "object" && p !== null) {
				switch (p.$$typeof) {
					case ue:
						return (
							(v = Al(p.type, p.key, p.props, null, y.mode, v)),
							(v.ref = vr(y, null, p)),
							(v.return = y),
							v
						);
				...
				if (Kn(p) || H(p))
					return (p = yn(p, y.mode, v, null)), (p.return = y), p;
				pl(y, p);
			}
			return null;
		}
		function k(y, p, v, P) {
			...
			if (typeof v == "object" && v !== null) {
				switch (v.$$typeof) {
					...
					case Ue:
						return (D = v._init), k(y, p, D(v._payload), P);
				}
		...
		function R(y, p, v, P, D) {
			if ((typeof P == "string" && P !== "") || typeof P == "number")
				return (y = y.get(v) || null), c(p, y, "" + P, D);
			if (typeof P == "object" && P !== null) {
				switch (P.$$typeof) {
					case ue:
						return (
							(y = y.get(P.key === null ? v : P.key) || null), d(p, y, P, D)
						);
					case ee:
						return (
							(y = y.get(P.key === null ? v : P.key) || null), g(p, y, P, D)
						);
					case Ue:
						var U = P._init;
		...
		function L(y, p, v, P) {
			for (
				var D = null, U = null, B = p, $ = (p = 0), Ne = null;
				B !== null && $ < v.length;
				$++
			) {
			...
			if (B === null) {
				for (; $ < v.length; $++)
					(B = x(y, v[$], P)),
						B !== null &&
							((p = u(B, p, $)),
							U === null ? (D = B) : (U.sibling = B),
							(U = B));
				return he && sn(y, $), D;
			}
			for (B = r(y, B); $ < v.length; $++)
				(Ne = R(B, y, $, v[$], P)),
					Ne !== null &&
						(e &&
							Ne.alternate !== null &&
							B.delete(Ne.key === null ? $ : Ne.key),
						(p = u(Ne, p, $)),
						U === null ? (D = Ne) : (U.sibling = Ne),
						(U = Ne));
			return (
				e &&
					B.forEach(function (tn) {
						return t(y, tn);
					}),
				he && sn(y, $),
				D
		...
		function I(y, p, v, P) {
			...
			for (
				var U = (D = null), B = p, $ = (p = 0), Ne = null, le = v.next();
				B !== null && !le.done;
				$++, le = v.next()
			) {
				B.index > $ ? ((Ne = B), (B = null)) : (Ne = B.sibling);
				...
				e && B && tn.alternate === null && t(y, B),
					(p = u(tn, p, $)),
					U === null ? (D = tn) : (U.sibling = tn),
					(U = tn),
					(B = Ne);
			}
			if (le.done) return n(y, B), he && sn(y, $), D;
			if (B === null) {
				for (; !le.done; $++, le = v.next())
					(le = x(y, le.value, P)),
						le !== null &&
							((p = u(le, p, $)),
							U === null ? (D = le) : (U.sibling = le),
			...
			for (B = r(y, B); !le.done; $++, le = v.next())
				(le = R(B, y, $, le.value, P)),
					le !== null &&
						(e &&
							le.alternate !== null &&
							B.delete(le.key === null ? $ : le.key),
						(p = u(le, p, $)),
						U === null ? (D = le) : (U.sibling = le),
						(U = le));
			return (
				e &&
					B.forEach(function (lp) {
						return t(y, lp);
					}),
				he && sn(y, $),
				D
		...
		function ke(y, p, v, P) {
				...
				switch (v.$$typeof) {
					case ue:
						e: {
							...
							v.type === te
								? ((p = yn(v.props.children, y.mode, P, v.key)),
									(p.return = y),
									(y = p))
								: ((P = Al(v.type, v.key, v.props, null, y.mode, P)),
									(P.ref = vr(y, p, v)),
			...
			return (typeof v == "string" && v !== "") || typeof v == "number"
				? ((v = "" + v),
					p !== null && p.tag === 6
						? (n(y, p.sibling), (p = l(p, v)), (p.return = y), (y = p))
						: (n(y, p), (p = Ki(v, y.mode, P)), (p.return = y), (y = p)),
					o(y))
				: n(y, p);
		}
		return ke;
	...
	function vl(e, t, n, r) {
		...
		if (c !== null) {
			...
			C !== null &&
				...
				(c = C.lastBaseUpdate),
				c !== o &&
					(c === null ? (C.firstBaseUpdate = g) : (c.next = g),
					(C.lastBaseUpdate = d)));
		}
		if (u !== null) {
			var x = l.baseState;
					...
					e: {
						...
						switch (((k = t), (R = n), I.tag)) {
							...
							case 0:
								if (
									((L = I.payload),
									(k = typeof L == "function" ? L.call(R, x, k) : L),
									k == null)
								)
									break e;
								x = O({}, x, k);
	...
	function hi(e, t, n, r, l, u) {
		if (
			...
			(t.updateQueue = null),
			(t.lanes = 0),
			(wl.current = e === null || e.memoizedState === null ? Md : zd),
			(e = n(r, l)),
			kr)
		) {
			u = 0;
	...
	function yi(e) {
		...
		if (((e = n.interleaved), e !== null)) {
			l = e;
			do (u = l.lane), (ve.lanes |= u), (dn |= u), (l = l.next);
			while (l !== e);
	...
	function ta(e, t) {
		...
		if (
			(u && ((r.memoizedState = l), (He = !0)),
			(r = r.queue),
			gi(la.bind(null, n, r, e), [e]),
			r.getSnapshot !== t || u || (xe !== null && xe.memoizedState.tag & 1))
		) {
			if (
				((n.flags |= 2048),
				Cr(9, ra.bind(null, n, r, l, t), void 0, null),
				Pe === null)
			)
				throw Error(a(349));
			(fn & 30) !== 0 || na(n, t, l);
	...
	function pa(e, t, n) {
		return (
			(n = n != null ? n.concat([e]) : null), _l(4, 4, da.bind(null, t, e), n)
		);
	}
	function wi() {}
	function ha(e, t) {
	...
	function ya(e, t, n) {
		return (fn & 21) === 0
			...
			: (ct(n, t) ||
					((n = Ko()), (ve.lanes |= n), (dn |= n), (e.baseState = !0)),
				t);
	}
	function Nd(e, t) {
		var n = oe;
	...
	function Rd(e, t, n) {
		...
		if (ga(e)) wa(t, l);
			...
			(n = Ys(e, t, l, r)),
				n !== null && ((l = je()), mt(n, e, r, l), Sa(n, t, r));
		}
	}
	function ga(e) {
		var t = e.alternate;
		...
		Md = {
			...
			useImperativeHandle: function (e, t, n) {
				return (
					...
					kl(4194308, 4, da.bind(null, t, e), n)
				);
			},
			...
			useSyncExternalStore: function (e, t, n) {
				...
				return (
					(l.queue = u),
					aa(la.bind(null, r, u, e), [e]),
					(r.flags |= 2048),
					Cr(9, ra.bind(null, r, u, n, t), void 0, null),
					n
				);
			},
			useId: function () {
	...
	function ki(e, t, n, r) {
		...
		typeof u == "object" && u !== null
			? (l.context = rt(u))
			: ((u = We(t) ? un : Oe.current), (l.context = On(e, u))),
			(l.state = e.memoizedState),
			(u = t.getDerivedStateFromProps),
			typeof u == "function" && (Si(e, t, u, n), (l.state = e.memoizedState)),
...
` +
			...
			? (e === t
					...
					: ((e.flags |= 128),
						...
						n.tag === 1 &&
							(n.alternate === null
								? (n.tag = 17)
								: ((t = Ot(-1, 1)), (t.tag = 2), Gt(n, t, 1))),
						(n.lanes |= 1)),
				e)
			: ((e.flags |= 65536), (e.lanes = l), e);
	}
	var Id = Y.ReactCurrentOwner,
		He = !1;
	function Ae(e, t, n, r) {
		...
		return (
			...
			e !== null && !He
				? ((t.updateQueue = e.updateQueue),
					...
					(e.lanes &= ~l),
					Lt(e, t, l))
				: (he && n && Ju(t), (t.flags |= 1), Ae(e, t, r, l), t.child)
		);
	}
	function Ma(e, t, n, r, l) {
		if (e === null) {
			...
			return typeof u == "function" &&
				...
				? ((t.tag = 15), (t.type = u), za(e, t, u, r, l))
	...
	function za(e, t, n, r, l) {
		if (e !== null) {
			...
			if (cr(u, r) && e.ref === t.ref)
				if (((He = !1), (t.pendingProps = r = u), (e.lanes & l) !== 0))
		...
		return (
			...
			e !== null && !He
				? ((t.updateQueue = e.updateQueue),
					...
					(e.lanes &= ~l),
					Lt(e, t, l))
				: (he && r && Ju(t), (t.flags |= 1), Ae(e, t, n, l), t.child)
		);
	}
	function Ia(e, t, n, r, l) {
		...
		if ((jn(t, l), t.stateNode === null))
			Pl(e, t), _a(t, n, r), ki(t, n, r, l), (r = !0);
		else if (e === null) {
			var o = t.stateNode,
				c = t.memoizedProps;
			o.props = c;
			...
			(o.state = k),
				vl(t, r, o, l),
				(d = t.memoizedState),
				c !== r || k !== d || Be.current || Xt
					? (typeof C == "function" && (Si(t, n, C, r), (d = t.memoizedState)),
						(c = Xt || ka(t, n, c, r, k, d, g))
							? (x ||
			...
			(o = t.stateNode),
				Zs(e, t),
				(c = t.memoizedProps),
				(g = t.type === t.elementType ? c : dt(t.type, c)),
				(o.props = g),
				(x = t.pendingProps),
				(k = o.context),
				(d = n.contextType),
			...
			c !== x || k !== L || Be.current || Xt
				? (typeof R == "function" && (Si(t, n, R, r), (L = t.memoizedState)),
					(g = Xt || ka(t, n, g, r, k, L, d) || !1)
						? (C ||
								(typeof o.UNSAFE_componentWillUpdate != "function" &&
									typeof o.componentWillUpdate != "function") ||
								(typeof o.componentWillUpdate == "function" &&
									o.componentWillUpdate(r, L, d),
								typeof o.UNSAFE_componentWillUpdate == "function" &&
									o.UNSAFE_componentWillUpdate(r, L, d)),
	...
	function xi(e, t, n, r, l, u) {
		...
		return (
			(t.flags |= 1),
			e !== null && o
				? ((t.child = Fn(t, e.child, null, u)), (t.child = Fn(t, null, c, u)))
				: Ae(e, t, c, u),
	...
	function Aa(e, t, n) {
		...
		if (u) {
			...
			return (
				...
				c !== null ? (u = en(c, u)) : ((u = yn(u, o, n, null)), (u.flags |= 2)),
				(u.return = t),
				(r.return = t),
				(r.sibling = u),
				(t.child = r),
		...
		return (
			(u = e.child),
			(e = u.sibling),
			(r = en(u, { mode: "visible", children: r.children })),
	...
	function Dd(e, t, n, r, l, u, o) {
		if (n)
			return t.flags & 256
				? ((t.flags &= -257), (r = _i(Error(a(422)))), xl(e, t, o, r))
				: t.memoizedState !== null
		...
		if (l.data === "$!") {
			...
			return (
				(r = c), (u = Error(a(419))), (r = _i(u, r, void 0)), xl(e, t, o, r)
			);
		}
		if (((c = (o & e.childLanes) !== 0), He || c)) {
			if (((r = Pe), r !== null)) {
				...
				(l = (l & (r.suspendedLanes | o)) !== 0 ? 0 : l),
					l !== 0 &&
						l !== u.retryLane &&
						((u.retryLane = l), zt(e, l), mt(r, e, l, -1));
			}
	...
	function Ua(e, t, n) {
		var r = t.pendingProps,
			l = r.revealOrder,
			u = r.tail;
		if ((Ae(e, t, r.children, n), (r = ye.current), (r & 2) !== 0))
			(r = (r & 1) | 2), (t.flags |= 128);
		else {
		...
		(Wa = function (e, t, n, r) {
			...
			if (l !== r) {
				...
				for (g in r) {
					...
					if (
						((c = l?.[g]),
						r.hasOwnProperty(g) && d !== c && (d != null || c != null))
					)
						if (g === "style")
							if (c) {
								for (o in c)
								...
								for (o in d)
									d.hasOwnProperty(o) &&
										c[o] !== d[o] &&
										(n || (n = {}), (n[o] = d[o]));
							} else n || (u || (u = []), u.push(g, n)), (n = d);
						else
							g === "dangerouslySetInnerHTML"
								? ((d = d ? d.__html : void 0),
									(c = c ? c.__html : void 0),
									d != null && c !== d && (u = u || []).push(g, d))
								: g === "children"
		...
		switch ((qu(t), t.tag)) {
					...
					(e === null || e.child === null) &&
						(dl(t)
							...
							: e === null ||
								...
								((t.flags |= 1024), ft !== null && (Wi(ft), (ft = null)))),
					Mi(e, t),
					Ie(t),
					null
				);
				...
				if (((n = t.type), e !== null && t.stateNode != null))
					...
					if (((e = cn(_t.current)), dl(t))) {
						...
						(o = l.nodeType === 9 ? l : l.ownerDocument),
							e === "http://www.w3.org/1999/xhtml" && (e = To(n)),
								...
								if (c.hasOwnProperty(u)) {
									...
									u === "style"
										...
										: u === "dangerouslySetInnerHTML"
											? ((d = d ? d.__html : void 0), d != null && Ro(e, d))
											: u === "children"
												? typeof d == "string"
													? (n !== "textarea" || d !== "") && Xn(e, d)
													: typeof d == "number" && Xn(e, "" + d)
												: u !== "suppressContentEditableWarning" &&
													u !== "suppressHydrationWarning" &&
													u !== "autoFocus" &&
													(m.hasOwnProperty(u)
														? d != null && u === "onScroll" && fe("scroll", e)
														: d != null && Q(e, u, d, o));
								}
							switch (n) {
								case "input":
			...
			case 13:
				if (
					...
					if (he && Je !== null && (t.mode & 1) !== 0 && (t.flags & 128) === 0)
						Qs(), Dn(), (t.flags |= 98560), (u = !1);
			...
			case 19:
				...
				if (((r = (t.flags & 128) !== 0), (o = u.rendering), o === null))
					if (r) xr(u, !1);
						...
						u.tail !== null &&
							Se() > Vn &&
							((t.flags |= 128), (r = !0), xr(u, !1), (t.lanes = 4194304));
					}
				else {
					if (!r)
						if (((e = gl(o)), e !== null)) {
	...
	function Bd(e, t) {
				...
				e: {
					...
					if (r && r.rangeCount !== 0) {
						...
						t: for (;;) {
							for (
								var R;
								x !== n || (l !== 0 && x.nodeType !== 3) || (c = o + l),
									x !== u || (r !== 0 && x.nodeType !== 3) || (d = o + r),
		...
		for (
			$u = { focusedElem: e, selectionRange: n }, Xr = !1, z = t;
			z !== null;
		)
									...
									if (L !== null) {
										var I = L.memoizedProps,
											...
											p = y.getSnapshotBeforeUpdate(
												t.elementType === t.type ? I : dt(t.type, I),
												ke,
											);
	...
	function Xa(e, t, n) {
		...
		switch (n.tag) {
			...
			case 22:
				n.mode & 1
					? ((De = (r = De) || n.memoizedState !== null), Yt(e, t, n), (De = r))
					: Yt(e, t, n);
				break;
			default:
				Yt(e, t, n);
		...
		switch (e.tag) {
			...
			case 5:
				...
				if (r & 4 && ((l = e.stateNode), l != null)) {
					...
					if (((e.updateQueue = null), d !== null))
						try {
							c === "input" && u.type === "radio" && u.name != null && Eo(l, u),
								fu(c, o);
							var g = fu(c, u);
			...
			case 22:
				if (
					...
					e.mode & 1 ? ((De = (g = De) || C), ht(t, e), (De = g)) : ht(t, e),
					Ct(e),
					r & 8192)
				) {
					if (
	...
	function Za(e, t, n) {
		for (var r = (e.mode & 1) !== 0; z !== null; ) {
			...
			if (l.tag === 22 && r) {
				...
				if (!o) {
					var c = l.alternate,
						d = (c !== null && c.memoizedState !== null) || De;
					c = Nl;
					var g = De;
					if (((Nl = o), (De = d) && !g))
						for (z = l; z !== null; )
	...
	var Hd = Math.ceil,
		Rl = Y.ReactCurrentDispatcher,
		Di = Y.ReactCurrentOwner,
		ut = Y.ReactCurrentBatchConfig,
		q = 0,
		Pe = null,
		_e = null,
		Me = 0,
		...
		return (e.mode & 1) === 0
			...
			: (q & 2) !== 0 && Me !== 0
				...
				: xd.transition !== null
					...
					: ((e = oe),
						e !== 0 ||
							((e = window.event), (e = e === void 0 ? 16 : ts(e.type))),
						e);
	}
	function mt(e, t, n, r) {
	...
	function $e(e, t) {
		...
		var r = $r(e, e === Pe ? Me : 0);
		if (r === 0)
			n !== null && Vo(n), (e.callbackNode = null), (e.callbackPriority = 0);
		else if (((t = r & -r), e.callbackPriority !== t)) {
			if ((n != null && Vo(n), t === 1))
				e.tag === 0 ? Cd(tc.bind(null, e)) : Bs(tc.bind(null, e)),
					Sd(function () {
						(q & 6) === 0 && Kt();
					}),
					(n = null);
	...
	function ec(e, t) {
		...
		if ((r & 30) !== 0 || (r & e.expiredLanes) !== 0 || t) t = Fl(e, r);
			...
			ri(),
				(Rl.current = u),
				(q = l),
				_e !== null ? (t = 0) : ((Pe = null), (Me = 0), (t = Ce));
		}
		if (t !== 0) {
			if (
				(t === 2 && ((l = wu(e)), l !== 0 && ((r = l), (t = Bi(e, l)))),
				t === 1)
			)
				throw ((n = Nr), hn(e, 0), bt(e, r), $e(e, Se()), n);
			if (t === 6) bt(e, r);
			else {
				if (
				...
				switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
					...
					case 3:
						if (
							(bt(e, r),
							(r & 130023424) === r && ((t = Ai + 500 - Se()), 10 < t))
						) {
							if ($r(e, 0) !== 0) break;
	...
	function $n() {
		if (Jt !== null) {
			var e = Xo(Ll),
				...
				n = oe;
			try {
				if (((ut.transition = null), (oe = 16 > e ? 16 : e), Jt === null))
					var r = !1;
				else {
					if (((e = Jt), (Jt = null), (Ll = 0), (q & 6) !== 0))
						throw Error(a(331));
					var l = q;
					...
					if (
						((q = l), Kt(), St && typeof St.onPostCommitFiberRoot == "function")
					)
						try {
	...
	function Xd(e, t, n) {
		...
		r !== null && r.delete(t),
			...
			Pe === e &&
				(Me & n) === n &&
				(Ce === 4 || (Ce === 3 && (Me & 130023424) === Me && 500 > Se() - Ai)
					? hn(e, 0)
					: (Fi |= n)),
			$e(e, t);
	}
		...
		switch (((t.lanes = 0), t.tag)) {
				...
				return (
					...
					l.$$typeof === void 0
						? ((t.tag = 1),
							...
							ki(t, r, e, n),
							(t = xi(null, t, r, !0, u, n)))
						: ((t.tag = 0), he && u && Ju(t), Ae(null, t, l, n), (t = t.child)),
					t
				);
			case 16:
				r = t.elementType;
			...
			case 5:
				return (
					...
					(o = l.children),
					Qu(r, l) ? (o = null) : u !== null && Qu(r, u) && (t.flags |= 32),
					La(e, t),
					Ae(e, t, o, n),
					t.child
				);
	...
	function Al(e, t, n, r, l, u) {
		...
		if (((r = e), typeof e == "function")) Qi(e) && (o = 1);
			...
			e: switch (e) {
				...
				case vt:
					return (
						(e = it(12, n, t, l | 2)), (e.elementType = vt), (e.lanes = u), e
					);
				case Xe:
		...
		return (
			(t = it(o, n, t, l)), (t.elementType = e), (t.type = r), (t.lanes = u), t
		);
	}
	function yn(e, t, n, r) {
	...
	(Wl.prototype.render = Zi.prototype.render =
		function (e) {
			var t = this._internalRoot;
			if (t === null) throw Error(a(409));
			Ul(e, t, null, null);
		}),
		(Wl.prototype.unmount = Zi.prototype.unmount =
			function () {
	...
	(Go = function (e) {
		...
		(Do = Hi),
		(Fo = pn);
	var np = { usingClientEntryPoint: !1, Events: [yr, Mn, il, Lo, Io, Hi] },
		Mr = {
		...
		rp = {
			...
			findFiberByHostInstance: Mr.findFiberByHostInstance || ep,
	...
	return (
		...
		(Qe.hydrateRoot = function (e, t, n) {
			...
			if (
				...
				(t = fc(t, null, e, 1, n ?? null, l, !1, u, o)),
				(e[Nt] = t.current),
				pr(e),
				r)
			)
...
function yp() {
	...
	var a = typeof Object.is == "function" ? Object.is : s,
		...
		N = i.useDebugValue;
	return (
		(lo.useSyncExternalStoreWithSelector = function (S, F, M, A, j) {
			var K = m(null);
			if (K.current === null) {
			...
			K = _(
				function () {
					function W(ue) {
						if (!se) {
							if (
								((se = !0), (V = ue), (ue = A(ue)), j !== void 0 && b.hasValue)
							) {
								var ee = b.value;
								if (j(ee, ue)) return (Q = ee);
							}
							return (Q = ue);
						}
						if (((ee = Q), a(V, ue))) return ee;
						var te = A(ue);
						return j !== void 0 && j(ee, te)
							? ((V = ue), ee)
							: ((V = ue), (Q = te));
					}
					var se = !1,
...
function Sp() {
	...
	return {
		...
		subscribe(a) {
			...
			return (
				m.prev ? (m.prev.next = m) : (i = m),
				function () {
					!f ||
						i === null ||
						((f = !1),
						m.next ? (m.next.prev = m.prev) : (s = m.prev),
						m.prev ? (m.prev.next = m.next) : (i = m.next));
				}
			);
		},
	};
...
var _p = () =>
		...
		typeof window.document.createElement < "u",
	Ep = /* @__PURE__ */ _p(),
	Cp = () => typeof navigator < "u" && navigator.product === "ReactNative",
	xp = /* @__PURE__ */ Cp(),
	Pp = () => (Ep || xp ? Ke.useLayoutEffect : Ke.useEffect),
	Np = /* @__PURE__ */ Pp(),
	Tp = /* @__PURE__ */ Symbol.for("react-redux-context"),
	Rp =
		typeof globalThis < "u"
			? globalThis
...
function Mp() {
	...
	return s || ((s = Ke.createContext(null)), i.set(Ke.createContext, s)), s;
}
var Xl = /* @__PURE__ */ Mp();
function zp(i) {
	const { children: s, context: a, serverState: f, store: m } = i,
		w = Ke.useMemo(() => {
			const S = kp(m);
			return {
				store: m,
		...
		_ = Ke.useMemo(() => m.getState(), [m]);
	Np(() => {
		const { subscription: S } = w;
		return (
			(S.onStateChange = S.notifyNestedSubs),
			S.trySubscribe(),
			_ !== m.getState() && S.notifyNestedSubs(),
			() => {
...
var Lp = /* @__PURE__ */ Wc(),
	Ip = (i, s) => i === s;
function Dp(i = Xl) {
	const s = i === Xl ? Lp : Wc(i),
		a = (f, m = {}) => {
			const { equalityFn: w = Ip } =
					typeof m == "function" ? { equalityFn: m } : m,
				_ = s(),
				{ store: N, subscription: S, getServerState: F } = _;
			Ke.useRef(!0);
...
var Hc = /* @__PURE__ */ Dp(),
	xt = /* @__PURE__ */ ((i) => (
		(i.Message = "Message"),
		(i.MediaMessage = "MediaMessage"),
		(i.SkipAlert = "SkipAlert"),
		(i.ReplayAlert = "ReplayAlert"),
		(i.AlertPlaying = "AlertPlaying"),
		(i.AlertPlayed = "AlertPlayed"),
		(i.MediaPlaying = "MediaPlaying"),
		(i.SkipPlayingMedia = "SkipPlayingMedia"),
		(i.SkipPlayingAlert = "SkipPlayingAlert"),
		(i.MediaEnd = "MediaEnd"),
		(i.MediaError = "MediaError"),
		(i.MediaPaused = "MediaPaused"),
		(i.PauseMedia = "PauseMedia"),
		(i.MediaPlayed = "MediaPlayed"),
		(i.PlayMedia = "PlayMedia"),
		(i.SkipMedia = "SkipMedia"),
		(i.ReplayMedia = "ReplayMedia"),
		(i.Alerts = "Alerts"),
		(i.MakeAudioError = "MakeAudioError"),
		(i.Settings = "Settings"),
		(i.MediaSettings = "MediaSettings"),
		(i.StartAucFighterMatch = "StartAucFighterMatch"),
		(i.AucFighterMatchEnd = "AucFighterMatchEnd"),
		(i.PauseAucFighterMatch = "PauseAucFighterMatch"),
		(i.ResumeAucFighterMatch = "ResumeAucFighterMatch"),
		(i.AucFighterMatchPlaying = "AucFighterMatchPlaying"),
		(i.AucFighterMatchPaused = "AucFighterMatchPaused"),
		(i.UpdateAucFighterMatch = "UpdateAucFighterMatch"),
		(i.CancelAucFighterMatch = "CancelAucFighterMatch"),
		(i.AucFighterSettings = "AucFighterSettings"),
		(i.TestAlert = "TestAlert"),
		i
	))(xt || {});
function ze(i) {
...
var Fp = (typeof Symbol == "function" && Symbol.observable) || "@@observable",
	Nc = Fp,
...
function Vc(i, s, a) {
	...
	if (
		(typeof s == "function" && typeof a == "function") ||
		(typeof a == "function" && typeof arguments[3] == "function")
	)
		throw new Error(ze(0));
	if (
		(typeof s == "function" && typeof a > "u" && ((a = s), (s = void 0)),
		typeof a < "u")
	) {
		if (typeof a != "function") throw new Error(ze(1));
		return a(Vc)(i, s);
	}
	let f = i,
		m = s,
	...
	function M() {
		if (S) throw new Error(ze(3));
		return m;
	}
	function A(W) {
		if (typeof W != "function") throw new Error(ze(4));
		if (S) throw new Error(ze(5));
		let se = !0;
		F();
		const V = N++;
		return (
	...
	function j(W) {
		if (!mo(W)) throw new Error(ze(7));
		if (typeof W.type > "u") throw new Error(ze(8));
		if (typeof W.type != "string") throw new Error(ze(17));
		if (S) throw new Error(ze(9));
		try {
			(S = !0), (m = f(m, W));
		} finally {
			S = !1;
	...
	function K(W) {
		if (typeof W != "function") throw new Error(ze(10));
		(f = W),
			j({
				type: Gl.REPLACE,
			});
	...
	function b() {
		...
		return {
			 ...
			 */
			subscribe(se) {
				if (typeof se != "object" || se === null) throw new Error(ze(11));
				function V() {
					const Y = se;
					Y.next && Y.next(M());
				}
	...
	return function (_ = {}, N) {
		...
		for (let M = 0; M < f.length; M++) {
			const A = f[M],
				...
				K = _[A],
				b = j(K, N);
			if (typeof b > "u") throw (N && N.type, new Error(ze(14)));
			(F[A] = b), (S = S || b !== K);
		}
...
var Qc = Symbol.for("immer-nothing"),
...
function Kc(i) {
	...
	return a === Object
		? !0
		: typeof a == "function" && Function.toString.call(a) === Wp;
}
function Zl(i, s) {
	eu(i) === 0
...
function ao(i, s) {
	if (tu(i)) return new Map(i);
	if (nu(i)) return new Set(i);
	...
	if (s === !0 || (s === "class_only" && !a)) {
		...
		for (let w = 0; w < m.length; w++) {
			const _ = m[w],
				N = f[_];
			N.writable === !1 && ((N.writable = !0), (N.configurable = !0)),
				(N.get || N.set) &&
					(f[_] = {
						configurable: !0,
						writable: !0,
...
function yo(i, s = !1) {
	return (
		ru(i) ||
			gn(i) ||
			!Ft(i) ||
			(eu(i) > 1 && (i.set = i.add = i.clear = i.delete = Vp),
			Object.freeze(i),
			s && Object.entries(i).forEach(([a, f]) => yo(f, !0))),
		i
	);
}
function Vp() {
...
function zc(i, s) {
	...
	return (
		i !== void 0 && i !== a
			? (a[be].modified_ && (co(s), yt(4)),
				Ft(i) && ((i = Jl(s, i)), s.parent_ || ql(s, i)),
				s.patches_ &&
...
function Jl(i, s, a) {
	if (ru(s)) return s;
	const f = s[be];
	if (!f) return Zl(s, (m, w) => Oc(i, f, s, m, w, a)), s;
	if (f.scope_ !== i) return s;
	if (!f.modified_) return ql(i, f.base_, !0), f.base_;
	if (!f.finalized_) {
		(f.finalized_ = !0), f.scope_.unfinalizedDrafts_--;
		const m = f.copy_;
		let w = m,
			_ = !1;
		f.type_ === 3 && ((w = new Set(m)), m.clear(), (_ = !0)),
			Zl(w, (N, S) => Oc(i, f, m, N, S, a, _)),
			ql(i, m, !1),
			a &&
				i.patches_ &&
				wn("Patches").generatePatches_(f, a, i.patches_, i.inversePatches_);
	}
	return f.copy_;
}
function Oc(i, s, a, f, m, w, _) {
	if (gn(m)) {
		const N =
				w &&
				s &&
				s.type_ !== 3 && // Set objects are atomic since they have no keys.
				!so(s.assigned_, f)
					? w.concat(f)
					: void 0,
			S = Jl(i, m, N);
		if ((Xc(a, f, S), gn(S))) i.canAutoFreeze_ = !1;
		else return;
	} else _ && a.add(m);
	if (Ft(m) && !ru(m)) {
		...
		Jl(i, m),
			(!s || !s.scope_.parent_) &&
				typeof f != "symbol" &&
				Object.prototype.propertyIsEnumerable.call(a, f) &&
				ql(i, m);
	}
}
function ql(i, s, a = !1) {
...
var vo = {
		get(i, s) {
			if (s === be) return i;
			const a = vn(i);
			if (!so(a, s)) return Gp(i, a, s);
			const f = a[s];
			return i.finalized_ || !Ft(f)
				? f
				: f === io(i.base_, s)
					? (oo(i), (i.copy_[s] = ho(f, i)))
					: f;
		},
		has(i, s) {
			return s in vn(i);
		...
		set(i, s, a) {
			const f = Yc(vn(i), s);
			if (f?.set) return f.set.call(i.draft_, a), !0;
			if (!i.modified_) {
				const m = io(vn(i), s),
					w = m?.[be];
				if (w && w.base_ === a)
					return (i.copy_[s] = a), (i.assigned_[s] = !1), !0;
				if (Hp(a, m) && (a !== void 0 || so(i.base_, s))) return !0;
				oo(i), po(i);
			}
			return (
				(i.copy_[s] === a && // special case: handle new props with value 'undefined'
					(a !== void 0 || s in i.copy_)) || // special case: NaN
					(Number.isNaN(a) && Number.isNaN(i.copy_[s])) ||
					((i.copy_[s] = a), (i.assigned_[s] = !0)),
				!0
			);
		},
		deleteProperty(i, s) {
			return (
				io(i.base_, s) !== void 0 || s in i.base_
					? ((i.assigned_[s] = !1), oo(i), po(i))
		...
		getOwnPropertyDescriptor(i, s) {
			const a = vn(i),
				f = Reflect.getOwnPropertyDescriptor(a, s);
			return (
				f && {
					writable: !0,
...
function oo(i) {
	i.copy_ || (i.copy_ = ao(i.base_, i.scope_.immer_.useStrictShallowCopy_));
}
var Yp = class {
	constructor(i) {
		(this.autoFreeze_ = !0),
			...
			(this.produce = (s, a, f) => {
				...
				typeof a != "function" && yt(6),
					f !== void 0 && typeof f != "function" && yt(7);
				let m;
				if (Ft(s)) {
					const w = Mc(this),
						_ = ho(s, void 0);
			...
			typeof i?.autoFreeze == "boolean" && this.setAutoFreeze(i.autoFreeze),
			typeof i?.useStrictShallowCopy == "boolean" &&
	...
	applyPatches(i, s) {
		...
		return gn(i) ? f(i, s) : this.produce(i, (m) => f(m, s));
	}
};
function ho(i, s) {
	const a = tu(i)
		? wn("MapSet").proxyMap_(i, s)
		: nu(i)
			? wn("MapSet").proxySet_(i, s)
			: Xp(i, s);
...
function qc(i) {
	return ({ dispatch: a, getState: f }) =>
		(m) =>
		(w) =>
			typeof w == "function" ? w(a, f, i) : m(w);
}
var Jp = qc(),
	qp = qc,
...
var bc = class Or extends Array {
	...
	prepend(...s) {
		return s.length === 1 && Array.isArray(s[0])
			? new Or(...s[0].concat(this))
			: new Or(...s.concat(this));
	}
};
function Ic(i) {
	return Ft(i) ? Jc(i, () => {}) : i;
...
function ef(i) {
	...
	const m = {
		addCase(w, _) {
			...
			if (!N) throw new Error(Dt(28));
			if (N in s) throw new Error(Dt(29));
			return (s[N] = _), m;
		},
		addMatcher(w, _) {
			return (
...
function sh(i, s) {
	...
	function _(N = w(), S) {
		let F = [
			a[S.type],
			...f.filter(({ matcher: M }) => M(S)).map(({ reducer: M }) => M),
		];
		return (
			F.filter((M) => !!M).length === 0 && (F = [m]),
			F.reduce((M, A) => {
				if (A)
					if (gn(M)) {
						const K = A(M, S);
...
function fh({ creators: i } = {}) {
	const s = i?.asyncThunk?.[ah];
	return function (f) {
		const { name: m, reducerPath: w = m } = f;
		if (!m) throw new Error(Dt(11));
		const _ =
				(typeof f.reducers == "function" ? f.reducers(ph()) : f.reducers) || {},
			N = Object.keys(_),
			S = {
			...
			F = {
				addCase(V, Q) {
					...
					if (!Y) throw new Error(Dt(12));
					if (Y in S.sliceCaseReducersByType) throw new Error(Dt(13));
					return (S.sliceCaseReducersByType[Y] = Q), F;
				},
				addMatcher(V, Q) {
					return (
						S.sliceMatchers.push({
							matcher: V,
							reducer: Q,
						}),
						F
		...
		function M() {
			...
			return sh(f.initialState, (ee) => {
				for (let te in ue) ee.addCase(te, ue[te]);
				for (let te of S.sliceMatchers) ee.addMatcher(te.matcher, te.reducer);
				for (let te of Q) ee.addMatcher(te.matcher, te.reducer);
...
function hh({ type: i, reducerName: s, createNotation: a }, f, m) {
	let w, _;
	if ("reducer" in f) {
		if (a && !yh(f)) throw new Error(Dt(17));
		(w = f.reducer), (_ = f.prepare);
	} else w = f;
	m.addCase(i, w)
		.exposeCaseReducer(s, w)
		.exposeAction(s, _ ? Lc(i, _) : Lc(i));
}
function mh(i) {
...
function vh({ type: i, reducerName: s }, a, f, m) {
	if (!m) throw new Error(Dt(18));
	const {
			payloadCreator: w,
			fulfilled: _,
			pending: N,
		...
		A = m(i, w, M);
	f.exposeAction(s, A),
		_ && f.addCase(A.fulfilled, _),
		N && f.addCase(A.pending, N),
		S && f.addCase(A.rejected, S),
		F && f.addMatcher(A.settled, F),
		...
		tf({
			...
			reducers: {
				...
				subtractTime: (s, a) => {
					...
					f > 0
						? (s.time = f)
						: (clearInterval(s.currentIntervalId),
							(s.time = 0),
							(s.isStopped = !0));
				},
...
const nf = go("fighter-timer"),
	...
	wh = () => {
		const { isShowAnnouncer: i, match: s } = Hc((a) => a.mainState);
		return /* @__PURE__ */ Te.jsx(Te.Fragment, {
			children:
				i &&
				s &&
				/* @__PURE__ */ Te.jsxs("div", {
					...
					children: [
						/* @__PURE__ */ Te.jsxs("div", {
							style: Ac,
							children: ["#", s.teams[0].id, " ", s.teams[0].name],
						}),
						/* @__PURE__ */ Te.jsx("span", { children: " VS " }),
						/* @__PURE__ */ Te.jsxs("div", {
							style: Ac,
							children: ["#", s.teams[1].id, " ", s.teams[1].name],
						}),
					],
				}),
		});
	...
	Sh = () => {
		const { isNewRoundStart: i, match: s } = Hc((a) => a.mainState);
		return /* @__PURE__ */ Te.jsx(Te.Fragment, {
			children:
				s &&
				i &&
				/* @__PURE__ */ Te.jsxs(Te.Fragment, {
					children: [
						/* @__PURE__ */ Te.jsxs("div", {
							style: { ...jc, transform: "translate(170px, 0px)" },
							children: ["#", s.teams[0].id],
						}),
						/* @__PURE__ */ Te.jsxs("div", {
							style: { ...jc, transform: "translate(540px, 0px)" },
							children: ["#", s.teams[1].id],
						}),
					],
				}),
		});
	...
	_h = ({ match: i, oldMatch: s }) => {
		...
		a
			.getTeamA()
			.getEnergybar()
			.change(f.amount > w.amount ? 1e3 : -1e3),
			a
				.getTeamB()
				.getEnergybar()
				.change(m.amount > _.amount ? 1e3 : -1e3);
	},
	Uc = ({ amount: i, match: s, oldAmount: a, oldMatch: f }) => {
		const m = i / (s.teams[0].amount + s.teams[1].amount),
			w = HEALTHBAR.MAX - HEALTHBAR.MAX * m;
		if (a && f) {
			const _ = a / (f.teams[0].amount + f.teams[1].amount),
				N = HEALTHBAR.MAX - HEALTHBAR.MAX * _;
			return w - N;
		}
		return w;
	},
	rf = ({ match: i, oldMatch: s }) => {
		const a = game_.getMatch();
		if (!a) return;
		const f = i.teams[0],
			m = i.teams[1];
	...
	Eh = (i) => {
		...
		const s = i.reduce((m, w) => m + w, 0),
			a = Math.random() * s;
		let f = 0;
		for (let m = 0; m < i.length; m++) if (((f += i[m]), a < f)) return m;
		return i.length - 1;
	},
	Ch = {
		isGameStarted: !1,
...
const Mh = $c({
	...
	uf = (i) => {
		const s = i.teams[0],
			a = i.teams[1],
			f = Eh([s.amount, a.amount]);
		me.dispatch(Ph(f));
	},
	Oh = ({ match: i, oldMatch: s }) => {
		const a = game_.getMatch();
		if (!a) return;
		const f = i.teams[0],
			m = i.teams[1],
			w = s.teams[0],
			_ = s.teams[1],
			N = a.getTeamA().getPlayers(),
			S = a.getTeamB().getPlayers();
		N.length < 3 &&
			f.amount / w.amount >= 2 &&
			a
				.getTeamA()
				.addPlayer(a.getTeamA().getPlayer(0).User.getPlayer(), !0, !0),
			S.length < 3 &&
				m.amount / _.amount >= 2 &&
				a
					.getTeamB()
					.addPlayer(a.getTeamB().getPlayer(0).User.getPlayer(), !0, !0);
	};
class Lh {
	constructor(s) {
		s.addEventListener("open", () => {}), s.addEventListener("error", () => {});
	}
}
class Ih {
	subscribers;
	...
	notifySubscribers(s, a) {
		for (const f of this.subscribers) f.id === s && f.callback(a);
	}
	subscribe(s, a) {
		return (
			this.subscribers.push({ id: s, callback: a }),
			() => {
				this.subscribers = this.subscribers.filter((f) => f.callback !== a);
			}
		);
	}
}
class Dh extends Ih {
	...
	connect() {
		(!this.socket || this.socket.readyState !== WebSocket.OPEN) &&
			...
			(this.hotReload = new Lh(this.socket)),
...
const Pt = new Dh("ws://localhost:12553/ws"),
	Bc = [
		"ryu",
		"ken",
		"guy",
...
Pt.connect();
const { setTime: Fh, subtractTime: Ah, setCurrentIntervalId: jh } = nf.actions,
	Uh = HitSystem.prototype.register;
HitSystem.prototype.register = function (i) {
	const s = game_.getMatch();
	if (!s) return;
	const a = me.getState(),
		f = a.mainState.winnerIndex,
		m = s.getTeamA().getPlayers()[0],
		w = s.getTeamB().getPlayers()[0],
		_ = f === 1 ? m.Id : w.Id;
	Uh.call(this, i),
		a.fighterTimerState.time === 0 &&
			i.PlayerID === _ &&
			(f === 0
				? s.getTeamB().getHealthbar().change(1e3)
				: s.getTeamA().getHealthbar().change(1e3));
};
const of = () => {
		const i = setInterval(() => {
			me.dispatch(Ah(10));
...
$$init();
Pt.subscribe(xt.StartAucFighterMatch, (i) => {
	me.dispatch(lu(!0));
	const s = i.teams[0],
		a = i.teams[1],
		f = stages_[Bc[Math.floor(Math.random() * Bc.length)]];
	me.dispatch(Nh(i)),
		game_.end(),
		(__noDamage = !0),
		user1_.resetChar(s.character, !1, !0),
		user2_.resetChar(a.character, !0, !0),
		game_.startMatch(0, [0], [1], f, () => {
			Pt.send({
...
announcer_.onNewRoundAnnounced = () => {
	const i = me.getState(),
		{ match: s, aucFighterSettings: a } = i.mainState;
	s &&
		a &&
		(rf({ match: s }),
		uf(s),
		sf(),
		me.dispatch(wo(!0)),
		me.dispatch(Fh(a.round_duration)),
		me.dispatch(So(!0)),
		me.dispatch(lu(!1)),
		of());
};
game_.onMatchEnd = () => {
	const i = me.getState(),
		{ winnerIndex: s, isGameStarted: a, match: f } = i.mainState;
	f &&
		a &&
		s !== null &&
		(me.dispatch(wo(!1)),
...
Pt.subscribe(xt.UpdateAucFighterMatch, (i) => {
	const s = me.getState(),
		{ match: a, aucFighterSettings: f } = s.mainState;
	f &&
		a &&
		a.id === i.id &&
		(rf({ match: i, oldMatch: a }),
		_h({ match: i, oldMatch: a }),
		f.is_add_players && Oh({ match: i, oldMatch: a }),
		uf(i),
		me.dispatch(Th(i)));
});
Pt.subscribe(xt.AucFighterSettings, (i) => {
	me.dispatch(xh(i));
});
...
document.addEventListener("keydown", function (i) {
	i.ctrlKey &&
		i.key === "2" &&
		(i.preventDefault(), game_.getMatch()?.getTeamA().getPlayer(0).enableAI());
});
mp.createRoot(document.getElementById("auc-fighter-adapter")).render(
	/* @__PURE__ */ Te.jsx(Ke.StrictMode, {
		children: /* @__PURE__ */ Te.jsx(Op, {
			store: me,
			children: /* @__PURE__ */ Te.jsx(kh, {}),
		}),
	}),
);
